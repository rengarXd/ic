...
;! function(win) {"use strict";
	...
	! function(W, D) {"use strict";
		...
		var defaultOptions = {
			...
			"pn" : "请输入正确的正数",
			"upn" : "请输入正确的负数"
		}, defautPropertys = ["data-rule", "data-nullmsg", "data-errmsg", "data-sucmsg", "data-ignore", "data-sync"];
		...
		var Core = function(options, rules) {
			...
			this.status = "prepare";
			// 验证状态，prepare,validating,success,error,complete
			this.validate_way = "text";
			// 验证方式，对非表单元素有作用，默认只对元素文本内容验证
